            ...
            <form method="POST" action="{{ url('students') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control form-control-sm @error('txtid') is-invalid @enderror"
                            id="idstudents" name="txtid" value="{{ old('txtid') }}">
                        @error('txtid')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        @enderror" id="txtfullname" name="txtfullname" value="{{ old('txtfullname') }}">
                        @error('txtfullname')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        @enderror" name="txtaddress" id="txtaddress" cols="30" rows="10"></textarea>
                        @error('txtaddress')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                        ...
                        @error('txtemail') is-invalid @enderror">
                        @error('txtemail')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6">
                        ...
                        @error('txtphone') is-invalid @enderror" </div>
                        @error('txtphone')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
