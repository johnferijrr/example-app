...
@section('content')
                    ...
                    @else
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href={{ url('students') }}>Dashboard</a>
    ...
    <p class="d">E-Sarpras merupakan inovasi layanan dari Sekolah Vokasi UGM dalam membangun sistem sarana dan
        prasarana yang dapat diakses oleh seluruh civitas akademis UGM</p>
    <p class="e">15+</p>
    <p class="f">200+</p>
    <p class="g">50+</p>
    ...
    <div class="accordion" id="accordionExample">
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingOne">
                <button class="mm" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                    aria-expanded="true" aria-controls="collapseOne">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bagaimana proses sistem
                    peminjaman tools dan hardware ? </button>
            </h2>
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                data-bs-parent="#accordionExample">
                <div class="mk">
                    Proses peminjaman dapat dilakukan melalui platform e-sarpras vokasi sehingga memudahkan civitas akademik
                    untuk memonitoring dan approval peminjaman. </div>
            </div>
        </div>
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingTwo">
                <button class="mm" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo"
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
                <button class="mm" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree"
                    aria-expanded="false" aria-controls="collapseThree">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Berapa
                    lama batas waktu peminjaman ?
                </button>
            </h2>
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingFour">
                <button class="mm" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour"
    ...
    <div class="accordion2" id="accordionExample">
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingFive">
                <button class="mm" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive"
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingSix">
                <button class="mm" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix"
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingSeven">
                <button class="mm" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven"
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingEight">
                <button class="mm" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEight"
    ...
    <div class="as"></div>
    <div class="at"></div>
    <p class="au">Departemen Teknik Elektro dan Informatika Sekolah Vokasi Universitas Gadjah Mada Jl. Yacaranda, Sekip
        Unit III, Yogyakarta. 55281 tedi.sv@ugm.ac.id (0274) 6491302, 561111 | (0274) 542908</p>
